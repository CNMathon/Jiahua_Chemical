      ...
      children: [
        {
          ...
          component: () => import('../views/pages/page_5/XueXi/Index.vue'),
          meta: {
            name: '学习',
            keepAlive: false //此组件需要被缓存
          }
        },
        {
          ...
          component: () => import('../views/pages/page_5/XueXi/Detail.vue'),
          meta: {
            name: '学习-详情',
            keepAlive: false //此组件需要被缓存
          },
      ...
      children: [
        {
          ...
          component: () => import('../views/pages/page_5/KaoShi/Index.vue'),
          meta: {
            name: '考试',
            keepAlive: false //此组件需要被缓存
          }
        },
        {
          ...
          component: () => import('../views/pages/page_5/KaoShi/Answer.vue'),
          meta: {
            name: '考试-答题',
            keepAlive: false //此组件需要被缓存
          }
