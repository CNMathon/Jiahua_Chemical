...
export default {
  ...
  methods: {
    saveData() {
      ...
      //   })
      // })
      console.log(this.sendData.ticketList)
      sendData.__sid = localStorage.JiaHuaSessionId; // sessionId
      sendData.factoryId = this.$userInfo.officeCode
      sendData.factoryName = this.$userInfo.officeName
      sendData.workOrderName = this.sendData.workOrderName
      sendData['project.projectName'] = this.sendData.projectInfo[0].projectName
      sendData.projectId = this.sendData.projectInfo[0].id
      sendData['deviceSpace.deviceCode'] = this.sendData.device[0].deviceCode
      sendData.deviceSpaceId = this.sendData.device[0].id
      sendData.workAddress = this.sendData.workAddress
      sendData.repairType = this.sendData.repairType
      sendData.repairTimeStart = this.sendData.repairTimeStart
      sendData.repairTimeEnd = this.sendData.repairTimeEnd
      sendData.repairTime = this.sendData.repairTime
      sendData.scenePersonName = this.userString(this.sendData.sceneInfo, "userName")
      sendData.scenePersonCode = this.userString(this.sendData.sceneInfo, "userCode")
      sendData.guardianshipName = this.userString(this.sendData.guardianshipInfo, "userName")
      sendData.guardianshipCode = this.userString(this.sendData.guardianshipInfo, "userCode")
      sendData.securityPersonName = this.userString(this.sendData.securityInfo, "userName")
      sendData.securityPersonCode = this.userString(this.sendData.securityInfo, "userCode")
      sendData.executorName = this.userString(this.sendData.executorInfo, "userName")
      sendData.executorCode = this.userString(this.sendData.executorInfo, "userCode")
      sendData.workContent = this.sendData.workContent
      sendData.repairTeam = this.sendData.repairTeam
      sendData.harmType = this.stringData("harmType", "harmTypeList")
      sendData.ticketList = this.sendData.ticketList
      // sendData.ticketCode = this.userString(this.sendData.ticketList, "ticketCode")
      // sendData.ticketType = this.userString(this.sendData.ticketList, "ticketType")
