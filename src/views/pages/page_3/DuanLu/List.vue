...
<template>
  <div class="home">
    ...
    <div class="filter">
      <j-filter-item :actions="zypztList"
            ...
            <div class="donghuo-list-card donghuo-list-card-nolast"
              ...
              <div class="left">
                ...
                <div class="left-line left-line-notlast"
                     v-if="item.reason == 1">断路原因：维修马路</div>
                <div class="left-line left-line-notlast"
                     v-if="item.reason == 2">断路原因：开挖埋设水管</div>
                <div class="left-line left-line-notlast"
                     v-if="item.reason == 3">断路原因：埋设电缆</div>
                <div class="left-line left-line-notlast"
                     v-if="item.reason == 4">断路原因：开挖沟渠</div>
                <div class="left-line left-line-notlast"
                     v-if="item.reason == 5">断路原因：吊装设备</div>
                <div class="left-line left-line-notlast"
                     v-if="item.reason == 6">断路原因：管道</div>
