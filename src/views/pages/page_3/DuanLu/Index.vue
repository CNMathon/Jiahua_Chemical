<template>
	<div class="mangban">
		<van-nav-bar title="断路安全" left-text="返回" right-text="操作" left-arrow @click-left="pageBack" @click-right="openAction" />
		<div class="cell_group">
			...
			<!-- 断路原因 -->
			<cell-select-tag required title="断路原因" storeKey="reason" :tagList="reason" :showList="list_1" :storeModule="storeModule"></cell-select-tag>
			<!-- 危害辨识 -->
			<cell-select-tag required title="危害辨识" storeKey="endangerSign" :tagList="endangerSign" :showList="list_2"
			...
			<!-- 作业部门负责人 -->
			<cell-select-user title="作业部门负责人" required :storeModule="storeModule" storeKey="workCharger" v-model="sendData.workCharger"></cell-select-user>
			<!-- 涉及部门 -->
			<div class="cell">
				<div class="cell_title">
					<span>涉及部门</span>
