  ...
  <div class="donghuo">
    ...
    <div class="cell_group fixed-first">
      ...
      <div class="fenxi">
        ...
        <!-- 动火分析时间 -->
        <cell-time v-model="sendData.dhfxTimeA" title="动火分析时间" required></cell-time>
        <!-- 分析点名称 -->
        <cell-input v-model="sendData.fxdNameA" title="分析点名称" required placeholder="手工录入"></cell-input>
        <!-- 可燃气体爆炸极限 -->
        <cell-picker
          title="可燃气体爆炸极限"
          required
        ...
        ></cell-picker>
        <!-- 分析数据 -->
        <cell-input v-model="sendData.fxDataA" title="分析数据" required placeholder="手工录入"></cell-input>
        <!-- 分析人 -->
        <select-organization 
          title="分析人"
          required
